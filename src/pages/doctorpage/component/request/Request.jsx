...
const NewAgreement = ({ setOpen }) => {
    ...
    const { data, loading, error } = useFetch(`https://medilocker-backend.onrender.com/api/agreement/request/${useremail}`);
    console.log(data);
    ...
    const deleteDocument = async (docId) => {
      ...
      const updateAgreement = async (docId) => {
        try {
          ...
          await axios.put(`https://medilocker-backend.onrender.com/api/agreement/update/${docId}`,{
            status:true
          });
